...
$arguments = array(
    array(
        'query' => "INSERT INTO student_master(SM_ID,SM_ID_Type,SM_Branch_Code,SM_Title,SM_First_Name,SM_Last_Name,SM_Gender,SM_Date_of_Birth,SM_Tell_Mobile,SM_Status,SM_Operator,SM_Reg_Date) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)",
        'bind' => $bind
    ),
    array(
