...
*/
$subjectsArray=array ( array ('DITEC-INT001 '),array ('DITEC-INT002 '),array ('DITEC-INT003 '),array ('DITEC-INT004 '),array ('DITEC-INT005 '),array ('DITEC-INT006 '),array ('DITEC-INT007 '),array ('DITEC-INT008 '),array ('DITEC-INT009 '),array ('DITEC-INT010 ') );


$InstallmentArray=array(
array( '1','2013-11-26','6000.00' ),
array( '1' , '2013-11-26','6000.00' ),
array( '1' , '2013-11-26','6000.00' ),
array( '1' , '2013-11-26','6000.00' ),
array( '1' , '2013-11-26','6000.00' ),
...
$pdf->SetXY(6,77);
    ...
    {  
            ...
            $pdf->Cell(23.2,5,$subjectsArray[$i][0],0);
			  if($i % 3 ==0) {
			  //$pdf->Ln();
			  $pdf->SetXY(6,$h+=9);
    ...
    for($i=1;$i<$count2;$i++)
    {  
			  if($i>7) {$pdf->SetXY(177,$h3+=3.5);}else{$pdf->SetXY(88,$h2+=3.5);}
