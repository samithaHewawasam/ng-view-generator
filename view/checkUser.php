...
<div id="alertForNextStep" ></div>
   ...
   <div class="center text-center" >
    ...
    <h2>Wait, I need your ID number !</h2>
...
<div id="fullRegistration">
 ...
 <div class="control-group">
  <label for="SM_Last_Name" class="control-label">Last Name:</label>
    <div class="controls">
      <input type="text" class="form-control" autocomplete="off"  maxlength="30" title="20 Characters Only" id="SM_Last_Name" name="SM_Last_Name" placeholder="Last Name" required>
...
<div class="control-group">
 <label for="SM_Tel_Residance" class="control-label">Phone Home:</label>
    <div class="controls">
      <input type="text" class="form-control" id="SM_Tel_Residance" autocomplete="off" name="SM_Tel_Residance" placeholder="Phone Home">
    </div>
  </div>
<div class="control-group">
 <label for="SM_Tell_Work" class="control-label">Phone Work:</label>
    <div class="controls">
      <input type="text" class="form-control" id="SM_Tell_Work" autocomplete="off" name="SM_Tell_Work" placeholder="Phone Work">
    </div>
  </div>
...
<div id="quickRegistration">
  ...
  <label for="date" class="control-label">Date:</label>
    ...
    <div class="controls"><input type="text" class="gotIdFromSearch" autocomplete="off" id="idNumberq" class="form-control" name="SM_ID" placeholder="902456478v" style="text-transform:uppercase">
    </div>
    </div>
