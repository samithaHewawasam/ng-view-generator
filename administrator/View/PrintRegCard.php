...
$Name1=$RegDetailsArray[0]['SM_Title'].' '.$RegDetailsArray[0]['SM_Initials'].' '.$RegDetailsArray[0]['SM_First_Name'];
...
$pdf->SetXY(6,68);
	...
	$h2=65;$h3=5;
    for($i=1;$i<$count2;$i++)
    {  if($InstallmentArray[$i][2]!='hello'){
			  if($i>6) {$pdf->SetXY(160,$h3+=3.5);}else{$pdf->SetXY(75,$h2+=3.5);}
