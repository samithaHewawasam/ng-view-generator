...
<input type="hidden" name="Old_SM_ID" value="<?php echo $SM_ID ?>" >
 <input type="hidden"  value="UpdateStudentMaster" name="UpdateStudentMaster" >
  ...
  <label for="SM_Full_Name" class="control-label">Full Name:</label>
    <div class="controls">
      <input type="hidden" class="form-control input-xxlarge" name="SM_Full_Name" value="<?php echo $SM_Full_Name ?>" placeholder="John Smith Elisabeth Francisco">
    </div>
  </div>
  <div class="control-group">
...
if (!empty($_POST['SM_First_Name']) && ctype_alpha(str_replace(array(' ', "."), '', $_POST['SM_First_Name']))) {
...
if (isset($_POST['SM_Last_Name']) && ctype_alpha(str_replace(array(' ', "."), '', $_POST['SM_Last_Name']))) {
