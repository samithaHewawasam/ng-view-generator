...
if($STH->rowCount()){
 ...
 $BM_Status=$row['BM_Status'];			
   ...
   Batch Number:
    ...
    <div class="controls">
    <input class="span3" readonly="" id="EdBatchNumber" value="<?php echo $BM_Batch_Code ?>" name="BM_Batch_Code" type="text">
    </div>
    </div>
	<div class="control-group">
   ...
   Target Exam:
    ...
    <div class="controls">
    <input id="EdBM_Target_Exam" name="BM_Target_Exam" value="<?php echo $BM_Target_Exam ?>" readonly="" type="text">
    </div>
	 </div> 
    <div class="control-group">
  <label for="BM_Ins_Days" class="control-label">Instalment Days:</label>
    ...
    <input class="span2" id="EdBM_Ins_Days" size="6" value="<?php echo $BM_Ins_Days ?>" name="BM_Ins_Days" type="text">
    ...
    <input class="span8 BM_Changes " id="EdBM_Commence_Date" size="16" value="<?php echo $BM_Commence_Date ?>" name="BM_Commence_Date" readonly="" type="text">
    ...
    <div class="controls">
        ...
        <div class="input-append date dp3" data-date-format="yyyy-mm-dd">
    <input class="span8" id="EdBM_End_Date" size="16"  value="<?php echo $BM_End_Date ?>" name="BM_End_Date" readonly="" type="text">
    <span class="add-on"><i class="icon-th"></i></span>
    </div>
    </div>
     </div>
