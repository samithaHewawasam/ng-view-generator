...
$arrayforexel[$row['Currency']][0]=array('Reg No','Stu ID','Student Name','Tell Mob','Tell Res','Tell Pare','Student E-mail','Course','Batch','Due Date','Due Age','Total Dues');	
$i=1;
	}
$NewCur=$row['Currency'];		
...
$arrayforexel[$row['Currency']][$i]=array($row['RG_Reg_NO'],$row['SM_ID'],$StudentName,$row['SM_Tell_Mobile'],$row['SM_Tel_Residance'],$row['SM_Parent_Phone'],$row['SM_Mail_Personal'],$row['C_Code'],$row['Default_Batch'],$row['D'],$DueAge,$row['C']);	
